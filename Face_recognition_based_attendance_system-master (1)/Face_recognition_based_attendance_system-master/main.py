...
hafi  = mysql.connector.connect(host = "localhost" , user = "root", password = "Hafeefa@#$2002", database = "sys")

if hafi.is_connected:
...
def TrackImages():
    ...
    sql = "INSERT INTO attendance_take( reg_no, name, date, time) VALUES ( %s, %s, %s, %s)"
    ...
    # query = "INSERT INTO attendance_table (reg_no,Name,Date,Time) VALUES (%s, %s, %s, %s)"
    # query = "INSERT INTO attendance_table (reg_no, Name, Date, Time) VALUES (%s, %s, %s, %s) " \
    ...
    #     try:
    #         cursor.execute("INSERT INTO attendance_table (reg_no, Name, Date, Time) VALUES (%s, %s, %s, %s)", 
    ...
    # cursor = hafi.cursor()
    # aisha=(attendance[0],attendance[2],attendance[4],attendance[6])

    # for i in  aisha:
    #     print(i)

    # huna = "INSERT INTO Attendance(s_no,regno,name,time,date) VALUES(%s,%s,%s,%s,%s)"


    # try:
    #     cursor.execute(huna,aisha)
    #     hafi.commit()
    #     print("Data added sucess!!!!!!!!!!!!!")  
